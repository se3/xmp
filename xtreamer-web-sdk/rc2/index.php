...
<tr><td valign=top>
	...
	<tr>
		<td><input type="button" name="vertical"  value=" " style="background: url('vertical.png');background-color:Transparent; height:35px; width:35px; border:none; cursor:hand" onclick="newwindow(10, 680, 'index.php');"></td>
	</tr>
	<tr>
